...
- Добавить `BearerAuth` security scheme в OpenAPI спек
- Задокументировать обязательные headers (`Origin`, `Referer`) как parameters
- Исправить схему ответов (`array` vs `object`) на основе реальных данных
...
- Покрытие дополнительных эндпоинтов по мере обнаружения
